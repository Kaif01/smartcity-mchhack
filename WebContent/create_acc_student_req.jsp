...
<body>
	...
	<div id="cssmenu">
		<ul>
			...
			<li><a href="create_acc_business_req.jsp">Resident
					Account</a></li>

			<li><a href="create_acc_tourist_req.jsp">Visitors
					Account</a></li>
		</ul>
	</div>
	...
	<table style="width: 897px; margin: 0 auto;">
		<tr>
			...
			<td width="1200" valign="top">
				<div id="welcome" >
					<h1>CREATE STUDENT ACCOUNT FORM</h1>
					<br>
					<table align="center">
						<tr>
							...
							<td>
								<form name=F1 onSubmit="return validate(this)"
									...
									<table cellspacing="5" cellpadding="3">
										...
										<tr>
											<td><input type="hidden" name="usertype" value="s" /></td>
										</tr>
